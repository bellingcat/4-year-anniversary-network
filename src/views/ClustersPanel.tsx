...
const ClustersPanel: FC<{
  ...
  return (
    ...
    >
      <p>
        <i className="text-muted">Click a cluster to show/hide related entities from the network. Clusters were assigned based on the channel the given entity was mentioned in most frequently.</i>
      </p>
      <p className="buttons">
